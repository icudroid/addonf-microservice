...
public class GenericServiceImpl<DOMAIN, DTO, PK extends Serializable> implements GenericService<DOMAIN, DTO, PK> {
    ...
    public GenericServiceImpl(EntityMapper<DTO, DOMAIN> mapper, ElasticsearchRepository<DOMAIN, PK> elasticsearchRepository, JpaRepository<DOMAIN, PK> repository) {
        this.mapper = mapper;
