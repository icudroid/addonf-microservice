...
@Configuration
@EntityScan("com.adloveyou.ms.transaction.domain")
@EnableJpaRepositories("com.adloveyou.ms.transaction.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.adloveyou.ms.transaction.repository.search")
