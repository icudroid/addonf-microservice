...
@Configuration
@EntityScan("com.adloveyou.ms.ad.domain")
@EnableJpaRepositories("com.adloveyou.ms.ad.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.adloveyou.ms.ad.repository.search")
