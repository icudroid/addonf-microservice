...
import com.adloveyou.ms.ad.repository.ProductRepository;
import com.adloveyou.ms.ad.service.ProductService;
import com.adloveyou.ms.ad.repository.search.ProductSearchRepository;
import com.adloveyou.ms.ad.service.dto.ProductDTO;
import com.adloveyou.ms.ad.service.mapper.ProductMapper;
...
public class ProductResourceIntTest {
    ...
    private static final BigDecimal DEFAULT_PUBLIC_PRICE = new BigDecimal(1);
    private static final BigDecimal UPDATED_PUBLIC_PRICE = new BigDecimal(2);

    private static final Integer DEFAULT_AD_PRICE = 1;
    private static final Integer UPDATED_AD_PRICE = 2;
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getPublicPrice()).isEqualTo(DEFAULT_PUBLIC_PRICE);
        assertThat(testProduct.getAdPrice()).isEqualTo(DEFAULT_AD_PRICE);
    ...
    @Test
    @Transactional
    public void checkAdPriceIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setAdPrice(null);
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].adPrice").value(hasItem(DEFAULT_AD_PRICE)))
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.adPrice").value(DEFAULT_AD_PRICE))
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getPublicPrice()).isEqualTo(UPDATED_PUBLIC_PRICE);
        assertThat(testProduct.getAdPrice()).isEqualTo(UPDATED_AD_PRICE);
