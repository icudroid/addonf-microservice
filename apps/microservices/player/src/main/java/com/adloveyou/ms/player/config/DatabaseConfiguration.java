...
@Configuration
@EntityScan("com.adloveyou.ms.player.domain")
@EnableJpaRepositories("com.adloveyou.ms.player.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.adloveyou.ms.player.repository.search")
