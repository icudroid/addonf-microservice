...
@Configuration
@EntityScan("com.adloveyou.ms.billing.domain")
@EnableJpaRepositories("com.adloveyou.ms.billing.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.adloveyou.ms.billing.repository.search")
