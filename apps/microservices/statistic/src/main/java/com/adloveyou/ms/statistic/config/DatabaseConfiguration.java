...
@Configuration
@EntityScan("com.adloveyou.ms.statistic.domain")
@EnableJpaRepositories("com.adloveyou.ms.statistic.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.adloveyou.ms.statistic.repository.search")
