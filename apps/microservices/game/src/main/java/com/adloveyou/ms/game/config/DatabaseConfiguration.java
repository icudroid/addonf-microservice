...
@Configuration
@EntityScan("com.adloveyou.ms.game.domain")
@EnableJpaRepositories("com.adloveyou.ms.game.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.adloveyou.ms.game.repository.search")
