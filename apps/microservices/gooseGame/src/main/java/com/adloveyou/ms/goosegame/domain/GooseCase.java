...
public class GooseCase implements Serializable {
    ...
    public GooseCase name(String name) {
        this.name = name;
        return this;
    }
    ...
    public GooseCase gooseLevel(GooseLevel gooseLevel) {
    ...
    public boolean equals(Object o) {
        ...
        if (gooseCase.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), gooseCase.getId());
    }
