...
import com.adloveyou.ms.config.MetricsConfiguration;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("gooseGame");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("gooseGame");
        ...
        config.getMapConfigs().put("com.adloveyou.ms.goosegame.domain.*", initializeDomainMapConfig(jHipsterProperties));
