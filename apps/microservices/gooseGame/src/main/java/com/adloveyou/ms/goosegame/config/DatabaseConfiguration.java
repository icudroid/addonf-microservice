...
@Configuration
@EntityScan("com.adloveyou.ms.goosegame.domain")
@EnableJpaRepositories("com.adloveyou.ms.goosegame.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.adloveyou.ms.goosegame.repository.search")
