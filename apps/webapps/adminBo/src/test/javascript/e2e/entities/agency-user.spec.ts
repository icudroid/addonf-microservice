...
describe('AgencyUser e2e test', () => {
    ...
    it('should load AgencyUsers', () => {
        ...
        expect(agencyUserComponentsPage.getTitle()).toMatch(/adminBoApp.agencyUser.home.title/);
    ...
    it('should load create AgencyUser dialog', () => {
        ...
        expect(agencyUserDialogPage.getModalTitle()).toMatch(/adminBoApp.agencyUser.home.createOrEditLabel/);
