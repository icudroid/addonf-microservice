...
describe('Media e2e test', () => {
    ...
    it('should load Media', () => {
        ...
        expect(mediaComponentsPage.getTitle()).toMatch(/adminBoApp.media.home.title/);
    ...
    it('should load create Media dialog', () => {
        ...
        expect(mediaDialogPage.getModalTitle()).toMatch(/adminBoApp.media.home.createOrEditLabel/);
