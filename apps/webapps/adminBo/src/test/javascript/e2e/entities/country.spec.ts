...
describe('Country e2e test', () => {
    ...
    it('should load Countries', () => {
        ...
        expect(countryComponentsPage.getTitle()).toMatch(/adminBoApp.country.home.title/);
    ...
    it('should load create Country dialog', () => {
        ...
        expect(countryDialogPage.getModalTitle()).toMatch(/adminBoApp.country.home.createOrEditLabel/);
