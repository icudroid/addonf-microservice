...
describe('BrandUser e2e test', () => {
    ...
    it('should load BrandUsers', () => {
        ...
        expect(brandUserComponentsPage.getTitle()).toMatch(/adminBoApp.brandUser.home.title/);
    ...
    it('should load create BrandUser dialog', () => {
        ...
        expect(brandUserDialogPage.getModalTitle()).toMatch(/adminBoApp.brandUser.home.createOrEditLabel/);
