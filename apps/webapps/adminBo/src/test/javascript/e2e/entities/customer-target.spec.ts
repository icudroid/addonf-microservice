...
describe('CustomerTarget e2e test', () => {
    ...
    it('should load CustomerTargets', () => {
        ...
        expect(customerTargetComponentsPage.getTitle()).toMatch(/adminBoApp.customerTarget.home.title/);
    ...
    it('should load create CustomerTarget dialog', () => {
        ...
        expect(customerTargetDialogPage.getModalTitle()).toMatch(/adminBoApp.customerTarget.home.createOrEditLabel/);
