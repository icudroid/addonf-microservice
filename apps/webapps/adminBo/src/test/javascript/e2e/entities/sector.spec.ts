...
describe('Sector e2e test', () => {
    ...
    it('should load Sectors', () => {
        ...
        expect(sectorComponentsPage.getTitle()).toMatch(/adminBoApp.sector.home.title/);
    ...
    it('should load create Sector dialog', () => {
        ...
        expect(sectorDialogPage.getModalTitle()).toMatch(/adminBoApp.sector.home.createOrEditLabel/);
