...
describe('Contact e2e test', () => {
    ...
    it('should load Contacts', () => {
        ...
        expect(contactComponentsPage.getTitle()).toMatch(/adminBoApp.contact.home.title/);
    ...
    it('should load create Contact dialog', () => {
        ...
        expect(contactDialogPage.getModalTitle()).toMatch(/adminBoApp.contact.home.createOrEditLabel/);
