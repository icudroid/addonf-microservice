...
describe('City e2e test', () => {
    ...
    it('should load Cities', () => {
        ...
        expect(cityComponentsPage.getTitle()).toMatch(/adminBoApp.city.home.title/);
    ...
    it('should load create City dialog', () => {
        ...
        expect(cityDialogPage.getModalTitle()).toMatch(/adminBoApp.city.home.createOrEditLabel/);
