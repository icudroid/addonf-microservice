...
describe('FileAttachement e2e test', () => {
    ...
    it('should load FileAttachements', () => {
        ...
        expect(fileAttachementComponentsPage.getTitle()).toMatch(/adminBoApp.fileAttachement.home.title/);
    ...
    it('should load create FileAttachement dialog', () => {
        ...
        expect(fileAttachementDialogPage.getModalTitle()).toMatch(/adminBoApp.fileAttachement.home.createOrEditLabel/);
