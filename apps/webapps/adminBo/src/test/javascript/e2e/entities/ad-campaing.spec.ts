...
describe('AdCampaing e2e test', () => {
    ...
    it('should load AdCampaings', () => {
        ...
        expect(adCampaingComponentsPage.getTitle()).toMatch(/adminBoApp.adCampaing.home.title/);
    ...
    it('should load create AdCampaing dialog', () => {
        ...
        expect(adCampaingDialogPage.getModalTitle()).toMatch(/adminBoApp.adCampaing.home.createOrEditLabel/);
