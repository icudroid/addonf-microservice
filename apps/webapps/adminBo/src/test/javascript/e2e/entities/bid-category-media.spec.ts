...
describe('BidCategoryMedia e2e test', () => {
    ...
    it('should load BidCategoryMedias', () => {
        ...
        expect(bidCategoryMediaComponentsPage.getTitle()).toMatch(/adminBoApp.bidCategoryMedia.home.title/);
    ...
    it('should load create BidCategoryMedia dialog', () => {
        ...
        expect(bidCategoryMediaDialogPage.getModalTitle()).toMatch(/adminBoApp.bidCategoryMedia.home.createOrEditLabel/);
