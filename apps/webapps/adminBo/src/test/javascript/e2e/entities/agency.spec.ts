...
describe('Agency e2e test', () => {
    ...
    it('should load Agencies', () => {
        ...
        expect(agencyComponentsPage.getTitle()).toMatch(/adminBoApp.agency.home.title/);
    ...
    it('should load create Agency dialog', () => {
        ...
        expect(agencyDialogPage.getModalTitle()).toMatch(/adminBoApp.agency.home.createOrEditLabel/);
