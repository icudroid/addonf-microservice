...
describe('MeanOfContact e2e test', () => {
    ...
    it('should load MeanOfContacts', () => {
        ...
        expect(meanOfContactComponentsPage.getTitle()).toMatch(/adminBoApp.meanOfContact.home.title/);
    ...
    it('should load create MeanOfContact dialog', () => {
        ...
        expect(meanOfContactDialogPage.getModalTitle()).toMatch(/adminBoApp.meanOfContact.home.createOrEditLabel/);
