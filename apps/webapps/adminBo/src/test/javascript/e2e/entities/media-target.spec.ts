...
describe('MediaTarget e2e test', () => {
    ...
    it('should load MediaTargets', () => {
        ...
        expect(mediaTargetComponentsPage.getTitle()).toMatch(/adminBoApp.mediaTarget.home.title/);
    ...
    it('should load create MediaTarget dialog', () => {
        ...
        expect(mediaTargetDialogPage.getModalTitle()).toMatch(/adminBoApp.mediaTarget.home.createOrEditLabel/);
