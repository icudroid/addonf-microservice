...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("enrollAdvertiser");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("enrollAdvertiser");
        ...
        config.getMapConfigs().put("com.adloveyou.webapps.domain.*", initializeDomainMapConfig(jHipsterProperties));
