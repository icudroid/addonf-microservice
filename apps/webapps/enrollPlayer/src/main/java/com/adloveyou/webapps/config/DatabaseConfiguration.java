...
@Configuration
@EntityScan("com.adloveyou.webapps.domain")
@EnableJpaRepositories("com.adloveyou.webapps.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.adloveyou.webapps.repository.search")
