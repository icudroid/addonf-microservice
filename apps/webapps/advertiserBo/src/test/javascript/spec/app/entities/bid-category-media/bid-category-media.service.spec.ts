...
describe('Service Tests', () => {
    ...
    describe('BidCategoryMedia Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(BidCategoryMediaService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/bid-category-medias/' + 123);
            });
            it('should return BidCategoryMedia', () => {

                let entity: BidCategoryMedia;
                service.find(123).subscribe((_entity: BidCategoryMedia) => {
                    entity = _entity;
                });
