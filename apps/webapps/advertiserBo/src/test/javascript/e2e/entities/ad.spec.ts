...
describe('Ad e2e test', () => {
    ...
    it('should load Ads', () => {
        ...
        expect(adComponentsPage.getTitle()).toMatch(/advertiserBoApp.ad.home.title/);
    ...
    it('should load create Ad dialog', () => {
        ...
        expect(adDialogPage.getModalTitle()).toMatch(/advertiserBoApp.ad.home.createOrEditLabel/);
        adDialogPage.close();
    });
