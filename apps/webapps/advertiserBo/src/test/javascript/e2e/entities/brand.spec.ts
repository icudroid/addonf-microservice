...
describe('Brand e2e test', () => {
    ...
    it('should load Brands', () => {
        ...
        expect(brandComponentsPage.getTitle()).toMatch(/advertiserBoApp.brand.home.title/);
    ...
    it('should load create Brand dialog', () => {
        ...
        expect(brandDialogPage.getModalTitle()).toMatch(/advertiserBoApp.brand.home.createOrEditLabel/);
