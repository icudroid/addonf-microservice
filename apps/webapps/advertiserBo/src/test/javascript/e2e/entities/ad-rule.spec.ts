...
describe('AdRule e2e test', () => {
    ...
    it('should load AdRules', () => {
        ...
        expect(adRuleComponentsPage.getTitle()).toMatch(/advertiserBoApp.adRule.home.title/);
    ...
    it('should load create AdRule dialog', () => {
        ...
        expect(adRuleDialogPage.getModalTitle()).toMatch(/advertiserBoApp.adRule.home.createOrEditLabel/);
