...
describe('Product e2e test', () => {
    ...
    it('should load Products', () => {
        ...
        expect(productComponentsPage.getTitle()).toMatch(/advertiserBoApp.product.home.title/);
    ...
    it('should load create Product dialog', () => {
        ...
        expect(productDialogPage.getModalTitle()).toMatch(/advertiserBoApp.product.home.createOrEditLabel/);
