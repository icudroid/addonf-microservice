...
describe('MediaUser e2e test', () => {
    ...
    it('should load MediaUsers', () => {
        ...
        expect(mediaUserComponentsPage.getTitle()).toMatch(/advertiserBoApp.mediaUser.home.title/);
    ...
    it('should load create MediaUser dialog', () => {
        ...
        expect(mediaUserDialogPage.getModalTitle()).toMatch(/advertiserBoApp.mediaUser.home.createOrEditLabel/);
